...
Este projeto demonstra como utilizar Python, Business Intelligence (BI) e Machine Learning para analisar dados de vendas e gerar previsões de faturamento.

O objetivo é mostrar como dados podem apoiar tomadas de decisão estratégicas através de análise e modelos preditivos.
...
mês da venda
quantidade vendida
O modelo aprende padrões dos dados históricos e consegue prever o valor estimado de faturamento.
...
Autor
Projeto desenvolvido por Paulo Beni
